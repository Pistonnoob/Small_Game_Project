...
void EmitterEnemySpawn::ShutdownSpecific()
{
...
bool EmitterEnemySpawn::UpdateSpecific(float dT, ID3D11DeviceContext * deviceContext)
{
	bool result = false;
...
void EmitterEnemySpawn::Render(ID3D11DeviceContext * deviceContext, ParticleShaderParameters & emitterParameters, int & amountOfParticles)
{
	//NOT IMPLEMENTED
...
ID3D11ShaderResourceView * EmitterEnemySpawn::GetTexture()
{
	return this->texture;
}

int EmitterEnemySpawn::GetIndexCount()
{
	return this->indexCount;
}

bool EmitterEnemySpawn::SortParticles()
{
	return true;
}

bool EmitterEnemySpawn::InitializeEmitter()
{
...
bool EmitterEnemySpawn::InitializeBuffers(ID3D11Device * device)
{
...
void EmitterEnemySpawn::EmittParticles(float dT)
{
...
void EmitterEnemySpawn::UpdateParticles(float dT)
{
	//float size = 1.0f;
	//float x = 0, y = 0;
...
void EmitterEnemySpawn::KillParticles()
{
	//for (std::vector<Particle>::iterator node = this->root.begin(); node != this->root.end(); node++)
	//{
...
bool EmitterEnemySpawn::UpdateBuffers(ID3D11DeviceContext * deviceContext)
{
	HRESULT result;
...
void EmitterEnemySpawn::RenderBuffers(ID3D11DeviceContext * deviceContext)
{
	unsigned int stride;
	unsigned int offset;
